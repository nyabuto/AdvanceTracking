...
<head>
	...
	<!-- /theme JS files -->
        ...
        success:function(raw_data){
            var facility_id,unique_code,facility_name,county,position;
            var dataSet=[];
        
        var data=raw_data.data;
        for (var i=0; i<data.length;i++){
            position=i+1;
            facility_id=unique_code=facility_name=county="";
           ...
           var minSet = [position,county,facility_name,unique_code];
								...
								<ul class="icons-list">
			                		...
			                		<li><a data-action="close"></a></li>
                                            ...
                                            <div>
                                                ...
                                                <thead>
                                                    <tr><th>No.</th><th>County</th><th>Facility Name </th><th>Unique Code</th></tr></thead>
                                                <tbody>    
                                                </tbody>
                                               </table> 
                                            </div>
